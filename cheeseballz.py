...
Click the checkmark to continue once you're ready.""")
                ...
                try:
                    ...
                    try:
                        ...
                        embed = discord.Embed(title="Custom role created", color=0xffff00)
        ...
        if user is None or amount is None:
            ...
            if amount < 1:
                ...
                if bal < amount:
                    ...
                    embed.add_field(name="From user", value=context.author.mention, inline=True)
...
""")
    ...
    async def xmas(self, context):
        c.execute("SELECT xmas FROM cheeseballztable WHERE userid=?", (context.author.id,))
